...
매일 한 단락씩 논문을 읽을 수 있는 웹앱입니다.

1. 머신러닝·딥러닝을 이해하는 데 필수적인 논문 15편의 핵심 원문만 골라 단락으로 나눴습니다.
2. 구조로 흐름을 잡고 → 개념을 확인한 뒤 → 요약을 읽고 → 원문을 직접 읽으세요. 이 순서대로 내려가면 받아들이기 쉽습니다. 기본 개념은 **왕초보** 버튼으로 바로 볼 수 있습니다.
3. 하루 한 단락, 순서대로 읽으며 목표를 채울 수 있고, 기록 탭으로 연속 학습도 추적합니다.
4. 용어집·단어장으로 어려운 말을 찾거나, 플래시카드로 복습할 수 있습니다.

쓰는 법: `nonmun_helper.html`만 브라우저로 열면 됩니다.
...
- **논문** — 15편의 목록과 논문별 진행률. 누르면 그 논문의 다음 단락으로 갑니다.
